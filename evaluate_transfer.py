...
class TraitStrengthJudge:
    ...
    def __init__(self, judge_model_name: str = "gpt-5-mini-2025-08-07"):
        self.judge_model_name = judge_model_name
        self.judge_prompt_template = """Evaluate how strongly the following persona trait is expressed in this response.
...
0 = The trait is not expressed at all
5 = The trait is moderately expressed
10 = The trait is very strongly and clearly expressed
